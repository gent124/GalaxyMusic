    ...
    <div class="Lastestnews blog">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <span>Top listeners currenctly in these citities</span>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 margin">
                    <div class="news-box">
                        <figure><img src="images/berlin.jpg" alt="img" /></figure>
                        <h3>BERLIN</h3>
                        <span> March 20</span><span>Comment</span>
                        <p> 15M+ listeners Monthly </p>
                        <p> 110+ top songs </p>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 width">
                        <div class="address">
                            ...
                            <ul class="locarion_icon">
                                ...
                                <li><img src="icon/3.png" alt="icon" />Email : emri@email.com</li>
